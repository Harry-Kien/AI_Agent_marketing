...
| Content Creator Agent | Copywriter | Content pillar, hook, copy, CTA, calendar, script | Không tự bịa research, không publish |
| Content Strategy & Creative Agent | Content Strategist và Creative Director | Creative concept, visual brief, asset plan, image/video prompt, format variant | Không thay đổi claim hoặc CTA đã duyệt |
...
Bot Telegram cũ `@kien_content_creator_bot` là Content Creator Agent. Bot Telegram mới `@kien_content_creator1_bot` là Content Strategy & Creative Agent. Bot Telegram mới `@kien_page_growth_bot` là Page Growth & Community Agent.
...
### Content Strategy & Creative Package
